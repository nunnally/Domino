        ...
        <div role="tabpanel">
          <div className="panel pair-ranking-table" role="table" aria-label="Ranking de duplas">
            <div className="pair-ranking-head" role="row">
              <span>#</span><span>Dupla</span><span>Jogos</span><span>V</span><span>D</span><span>Aproveit.</span>
            </div>
            {pairs.map((pair, index) => (
              <div className="pair-ranking-row" role="row" aria-label={`${pair.label}, ${pair.wins} vitórias, ${pair.losses} derrotas, ${pair.winRate}%`} key={pair.pairKey}>
                ...
                <span className="pair-ranking-name">
                  ...
                  <span><strong>{pair.label}</strong>{pair.sampleSize === 'small' && <small>Amostra pequena</small>}</span>
                </span>
