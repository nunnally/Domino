...
export function LiveGameSetup({
  ...
  const renderPlayerField = (
    ...
    return (
      <div className="live-player-field">
        <span className="live-player-field-label">
          {label}
        </span>
        ...
        >
          <span className="live-player-trigger-content">
            {selected ? (
              ...
              <span className="live-player-empty-avatar">
                ?
              </span>
            )}
  ...
  const startGame = () => {
    ...
    if (
      ...
      setError(
        "Cada jogador pode participar apenas uma vez.",
      );
  ...
  return (
    <>
      <section className="page-wrap live-setup-page">
        ...
        {error && (
          <p
            className="form-error live-setup-error"
            role="alert"
          >
            {error}
          </p>
